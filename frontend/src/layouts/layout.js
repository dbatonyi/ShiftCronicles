      ...
      {isLoading ? (
        ...
        >
          <div className="app-container">
            <Head>
              <title>ShiftCronicles</title>
              <meta name="description" content="ShiftCronicles" />
              <link rel="icon" href="/favicon.ico" />
            </Head>

            <main className="shiftcronicles-main">
              {props.children}
              {statusMessage ? (
                <div className="shiftcronicles-system-message">
                  <div className="shiftcronicles-system-message--message">
                    {statusMessage}
                  </div>
                  <div
                    className="shiftcronicles-system-message--close"
                    onClick={() => {
                      setStatusMessage(null);
                    }}
                  >
